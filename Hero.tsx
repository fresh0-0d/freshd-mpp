...
const Hero = () => {
  ...
  return (
    <section 
      className="relative min-h-[90vh] flex flex-col justify-center px-6 lg:px-20 py-20 overflow-hidden"
    >
      <img
  src="/hero-natural-bg.png"
  alt=""
      ...
      <div className="relative z-10 max-w-6xl">
        ...
        >
            <span style={{ lineHeight: 1.4 }}>
              <span className="inline sm:inline-block sm:whitespace-nowrap">의료 트렌드와 환자 데이터를 기반으로</span><br />
              <span className="inline sm:inline-block sm:whitespace-nowrap">콘텐츠 성과를 만들어내는</span><br />
              <span className="text-[#0033FF] relative inline sm:inline-block sm:whitespace-nowrap">
                병원 콘텐츠 마케터로 성장하겠습니다.
              </span>
            </span>
        </h1>

        <div className="flex flex-col sm:flex-row flex-wrap gap-3 md:gap-6 animate-fade-in-up delay-500">
          <button 
